                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($students as $student): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="student_personal_info.php?id=<?= $student['Student_id']; ?>" class="btn btn-info btn-sm">
                                                        <i class="fas fa-fw fa-eye"></i>
                                                    </a>
                                                    <a href="edit_student_personal_info.php?id=<?= $student['Student_id']; ?>" class="btn btn-info btn-sm">
